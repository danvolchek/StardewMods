...
{
    /// <summary>
    ///     Base class for classes that handle side effects of re-adding removed
    ///     <see cref="StardewValley.TerrainFeatures.TerrainFeature" />.
    /// </summary>
    internal abstract class BaseHandler : ISideEffectHandler
    {
        protected IMonitor monitor;

        protected BaseHandler(IMonitor monitor)
        {
