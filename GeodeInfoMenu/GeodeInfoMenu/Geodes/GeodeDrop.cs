...
{
    /// <summary>
    /// Represents an item that can drop from a geode.
    /// </summary>
    public class GeodeDrop
    {
         ...
         ***/
        /// <summary>
        /// The underlying hardcoded item, if this is a hard coded item.
        /// </summary>
        public HardCodedGeodeDrop HardCodedDrop { get; }

        /// <summary>
        /// Whether or not this is a hardcoded drop.
        /// </summary>
        public bool IsHardCodedDrop { get; }

        /// <summary>
        /// The underlying item id, if this is not a hard coded item.
        /// </summary>
        ...
        /// <summary>
        /// Constructs an instance to be a hard coded drop.
        /// </summary>
        ...
        /// <summary>
        /// Constructs an instance to not be a hard coded drop.
        /// </summary>
