...
namespace GeodeInfoMenu.Menus
{
    ...
    internal class GeodeTabItem : OptionsElement
    {
        /***
         * Protected Fields
         ***/

        /// <summary>The item id of this item.</summary>
        protected int parentSheetIndex;

        /// <summary>The name of this item.</summary>
        protected string name;

        /// <summary>The size of the icon to draw for this item.</summary>
        protected const int SPRITE_SIZE = 64;

        /// <summary>A number to draw before this item, if it is in a numbered list.</summary>
        protected int numInFront;

        /// <summary>Whether to draw a star on this item's icon.</summary>
        protected bool drawStar;

        /// <summary>Where to draw this item.</summary>
        ...
        /// <summary>Draws this item on the screen.</summary>
