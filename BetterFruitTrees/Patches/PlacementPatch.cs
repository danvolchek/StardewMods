...
namespace BetterFruitTrees.Patches
{
    ...
    {
        public static bool Prefix(SObject instance, ref bool result, GameLocation location, int x, int y, Farmer who)
        {
            if (!instance.isSapling() || instance.ParentSheetIndex == 251) return true;
            ...
            var correctTileProperties =
                location is Farm &&
                (location.doesTileHaveProperty((int) placementTile.X, (int) placementTile.Y, "Diggable", "Back") !=
                 null ||
                 location.doesTileHavePropertyNoNull((int) placementTile.X, (int) placementTile.Y, "Type", "Back")
                     .Equals("Grass") ||
                 location.doesTileHavePropertyNoNull((int) placementTile.X, (int) placementTile.Y, "Type", "Back")
                     .Equals("Dirt")) &&
                !location.doesTileHavePropertyNoNull((int) placementTile.X, (int) placementTile.Y, "NoSpawn", "Back")
                    .Equals("Tree") ||
                location.CanPlantTreesHere(instance.ParentSheetIndex, (int) placementTile.X, (int) placementTile.Y) &&
                (location.doesTileHaveProperty((int) placementTile.X, (int) placementTile.Y, "Diggable", "Back") !=
                    null || location
                        .doesTileHavePropertyNoNull((int) placementTile.X, (int) placementTile.Y, "Type", "Back")
                        .Equals("Stone"));
            var gameValidLocation = location.IsFarm || location.IsGreenhouse || location is IslandLocation;
...

            {
                ...
                if (instance.ParentSheetIndex == 251)
                {
                ...
                var actAsGreenhouse = location.IsGreenhouse ||
                                      (instance.ParentSheetIndex == 69 || instance.ParentSheetIndex == 835) &&
                                      location is IslandWest;
                location.terrainFeatures.Add(placementTile,
                    new FruitTree(instance.ParentSheetIndex)
                    {
